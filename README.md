...
![SDK](https://img.shields.io/badge/SDK-functional--test--automation--sdk:1.1.4-blue)

> **Reusable Selenium + TestNG framework layer for OTI QA Automation**  
> Java 20+ * Maven * `com.test.automation:cross-platform-functional-test-automation-sdk:1.1.4`
...
*SDK: `com.test.automation:cross-platform-functional-test-automation-sdk:1.1.4`*
